//    google map start
    (function($) {
        ...
        function init() {
            var mapOptions = {
                center: new google.maps.LatLng(17.9933088,-92.9372959),
                zoom: 17,
                zoomControl: true,
                zoomControlOptions: {
            ...
            var locations = [
                ['SPECTRUM VILLAHERMOSA', 17.9933088,-92.9372959]
            ];
           ...
           var contentString = 
                '<div id="content">'+
                    '<div class="mapInfoWindowRowInner">'+
                        '<h5>SPECTRUM VILLAHERMOSA</h5>'+
                        '<p>Prolongación Miguel Hidalgo <br> Villahermosa, Tabasco</p>'+
                    '</div>'+
                '</div>';

        ...
        <div class="page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide page-sidebar-fixed scroll">
            ...
            <ul class="x-navigation">
                ...
                <li class="xn-openable <?php echo $this->router->getControllerName()=='photo'?"active":""?>">
                    <a href="#"><span class="fa fa-users"></span> <span class="xn-text">Capacitadores</span></a>
                    <ul>
                        <li class="<?php echo $this->router->getControllerName()=='trainer' && $this->router->getActionName()=='new'?"active":""?>"><a href="{{url('dashboard/trainer/new')}}"><span class="fa fa-user-plus"></span> Nueva capacitador</a></li>
                        <li class="<?php echo $this->router->getControllerName()=='trainer' &&  $this->router->getActionName()=='index'?"active":""?>"><a href="#"><span class="fa fa-user"></span> Capacitadores activos</a></li>
                        <li class="<?php echo $this->router->getControllerName()=='trainer' &&  $this->router->getActionName()=='inactive'?"active":""?>"><a href="#"><span class="fa fa-user-times"></span> Capacitadores inactivos</a></li>
                    </ul>
                </li>
                ...
                <li class="xn-openable <?php echo $this->router->getControllerName()=='user'?"active":""?>">
                    ...
                    <ul>
                        ...
                        <li class="<?php echo $this->router->getActionName()=='index' && $this->router->getControllerName()=='inactive'?"active":""?>">

    ...
    <div class="page-container">
        ...
        <div class="page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide page-sidebar-fixed scroll">
            ...
            <ul class="x-navigation">
                <li class="xn-logo">
                    <a href="{{url('dashboard')}}">SPECTRUM</a>
                ...
                <li class="xn-openable <?php echo $this->router->getControllerName()=='course'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getControllerName()=='course' && $this->router->getActionName()=='new'?"active":""?>"><a href="{{url('dashboard/course/new')}}"><span class="fa fa-pencil"></span> Nuevo curso</a></li>
                        <li class="<?php echo $this->router->getControllerName()=='course' && $this->router->getActionName()=='index'?"active":""?>"><a href="{{url('dashboard/courses')}}"><span class="fa fa-file"></span> Cursos activos</a></li>
                        <li class="<?php echo $this->router->getControllerName()=='course' && $this->router->getActionName()=='inactive'?"active":""?>"><a href="{{url('dashboard/courses/inactive')}}"><span class="fa fa-file-text-o"></span> Cursos inactivos</a></li>
                    </ul>
                </li>
                <li class="xn-openable <?php echo $this->router->getControllerName()=='photo'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getControllerName()=='trainer' && $this->router->getActionName()=='new'?"active":""?>"><a href="{{url('dashboard/instructor/new')}}"><span class="fa fa-user-plus"></span> Nuevo Instrutor</a></li>
                        <li class="<?php echo $this->router->getControllerName()=='trainer' &&  $this->router->getActionName()=='index'?"active":""?>"><a href="{{url('dashboard/instructors')}}"><span class="fa fa-user"></span> Instrutores activos</a></li>
                        <li class="<?php echo $this->router->getControllerName()=='trainer' &&  $this->router->getActionName()=='inactive'?"active":""?>"><a href="{{url('dashboard/instructors/inactive')}}"><span class="fa fa-user-times"></span> Instrutores inactivos</a></li>
                    </ul>
                </li>
                <li class="xn-openable <?php echo $this->router->getControllerName()=='category'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getActionName()=='index' && $this->router->getControllerName()=='category'?"active":""?>"><a href="{{url('dashboard/category')}}"><span class="fa fa-list-ul"></span>Especialidades</a></li>
                    </ul>
                </li>
                {% if auth['rol']=='ADMIN' %}
                <li class="xn-openable <?php echo $this->router->getControllerName()=='user'?"active":""?>">
                    ...
                    <ul>
                        ...
                        <li class="<?php echo $this->router->getActionName()=='index' && $this->router->getControllerName()=='user'?"active":""?>">
                            <a href="{{url('dashboard/users')}}"><span class="fa fa-user"></span> Usuarios Activos</a>
                        </li>
                        <li class="<?php echo $this->router->getActionName()=='inactive' && $this->router->getControllerName()=='user'?"active":""?>">
                            <a href="{{url('dashboard/user/inactive')}}"><span class="fa fa-user-secret"></span> Usiarios Inactivos</a>
                        </li>
                    </ul>
                </li>
                {%endif%}

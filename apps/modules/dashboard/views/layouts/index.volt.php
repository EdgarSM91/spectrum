    ...
    <div class="page-container">
        ...
        <div class="page-sidebar mCustomScrollbar _mCS_1 mCS-autoHide page-sidebar-fixed scroll">
            ...
            <ul class="x-navigation">
                <li class="xn-logo">
                    <a href="<?php echo $this->url->get('dashboard'); ?>">RETOS</a>
                ...
                <li class="xn-openable <?php echo $this->router->getControllerName()=='photo'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getControllerName()=='trainer' && $this->router->getActionName()=='new'?"active":""?>"><a href="<?php echo $this->url->get('dashboard/trainer/new'); ?>"><span class="fa fa-user-plus"></span> Nueva capacitador</a></li>
                ...
                <li class="xn-openable <?php echo $this->router->getControllerName()=='category'?"active":""?>">
                    ...
                    <ul>
                        <li class="<?php echo $this->router->getActionName()=='index' && $this->router->getControllerName()=='category'?"active":""?>"><a href="<?php echo $this->url->get('dashboard/category'); ?>"><span class="fa fa-list-ul"></span>Categorías</a></li>
                    </ul>
                </li>

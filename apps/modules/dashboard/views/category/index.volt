                    ...
                    <div class="table-responsive">
                        <table id="tableCategory" class="table table-bordered table-striped table-actions">
                            ...
                            <tr id="{{values.getCgid()}}">
                                ...
                                <td class="optionsCtg">
                                    <a href="#" data-cgid="{{values.getCgid()}}" data-namec="{{values.getName()}}" class="btn btn-default btn-rounded btn-sm btn-edit"><span class="fa fa-pencil"></span></a>
                                    <button class="btn btn-danger btn-rounded btn-sm deleteCg" data-cgid="{{values.getCgid()}}" data-namec="{{values.getName()}}"><span class="fa fa-times"></span></button>
                                </td>
                            </tr>
                            {% endfor %}
                            </tbody>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="alert alert-success fade in success hide" role="alert">
                    <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                    <strong>Categoría eliminado exitosamente</strong>
                </div>
            ...
            <form method="post" action="" name="delete-tag" id="delete-tag">
                <div class="modal-body">
                    <div class="col-lg-8">
                        <p>Esta seguro de eliminar la categoría <strong><span id="cgValue"></span></strong></p>
                    </div>
                </div>

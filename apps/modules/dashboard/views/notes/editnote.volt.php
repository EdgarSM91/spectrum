...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo $this->url->get('dashboard/notes'); ?>">Notas</a></li>
    <li class="active"><a href="#">Editar nota</a></li>
</ul>
<!-- PAGE TITLE -->
<div class="page-title">
    <h2><a href="<?php echo $this->url->get('dashboard/notes'); ?>"><span class="fa fa-arrow-circle-o-left"></span></a>  Salir</h2>
</div>
<!-- END PAGE TITLE -->
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12 col-xs-12 panel-body form-group-separated">
                <form action="#" method="post" id="updateNote" name="updateNote" role="form" class="form-horizontal">
                    ...
                    <input type="hidden" value="<?php echo $note->getPid(); ?>" name="pid"/>
                    <div class="form-group">
                        <label class="col-md-2 col-xs-12 control-label">Titulo</label>
                        <div class="col-md-8 col-xs-12">
                            <?php $new_title = str_replace('\'', '"', $note->getTitle());?>
                            <input id="note-title" type="text" class="form-control" placeholder="Titulo" name="title" value='<?php echo $new_title; ?>' required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input id="note-permalink" type="text" class="form-control" placeholder="Enlace o Permalink" name="permalink" value="<?php echo $note->getPermalink(); ?>" required readonly/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <div id="dropzone-note-edit" class="dropzone dz-default dz-message">
                                <div class="dz-default dz-message">
                                    <h2>
                                        ...
                                        <input type="hidden" value="<?php echo $note->getImage(); ?>" name="image" id="input-image-principal" >
                                    </h2>
                                </div>
                            </div>
                            <br/>
                            ...
                            <br/>
                            <input type="text" class="form-control" value="<?php echo $note->getDescriptionImage(); ?>" id="descriptionI" name="descriptionI" placeholder="Descripción de la imagen"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 col-xs-12 control-label">Sumario</label>
                        <div class="col-md-8 col-xs-12">
                            <textarea class="form-control" name="summary" id="" cols="10" rows="5"><?php echo $note->getSummary(); ?></textarea>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <select id="tid" name="tag[]" class="form-control selectM" data-placeholder="Agregar Tags" required multiple="multiple">
                                <?php foreach ($tags as $key=>$value):?>
                                    <option <?php echo !empty($activeTags[$key+1])==$value->getTid()?"selected":""?> value="<?php echo $value->getTid(); ?>"><?php echo $value->getNameTag(); ?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                        <div class="col-md-4 col-sm-6 col-xs-12">
                                ...
                                <?php foreach ($category as $key => $sub):?>
                                    <?php if(($sub!="Revista") && ($sub!="All")):?>
                                        <?php if($auth['ncgid']=='All'):?>
                                            <option <?php echo $categoryVal==$key?"selected":""?> value="<?php echo $key?>"><?php echo $sub; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 date" id="dateTop">
                            ...
                            ?>
                            <input type="text" class="form-control" id="datepicker" name="dateP" value="<?php echo $newDate; ?>">
                            <div id="element"></div>
                        </div>
                    </div>
                    <div class="form-group">

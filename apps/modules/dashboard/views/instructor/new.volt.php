...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo $this->url->get('dashboard/instructors'); ?>">Instructor</a></li>
    <li class="active"><a href="#">Nuevo Instructor</a></li>
</ul>
<!-- PAGE TITLE -->
<div class="page-title">
    <h2><a href="<?php echo $this->url->get('dashboard/instructors'); ?>"><span class="fa fa-arrow-circle-o-left"></span></a> Salir</h2>
</div>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12 col-xs-12 panel-body form-group-separated">
                <form action="#" method="post" id="newInstructor" name="newInstructor"role="form" class="form-horizontal">
                    ...
                    <input type="hidden" name="image" value="<?php echo $image; ?>" id="name-image"/>
                    <input type="hidden" name="curriculum" value="<?php echo $curriculum; ?>" id="name-curriculum"/>

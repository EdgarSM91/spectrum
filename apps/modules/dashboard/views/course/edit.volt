...
<ul class="breadcrumb">
    ...
    <li><a href="{{url('dashboard/course')}}">Cursos</a></li>
    <li class="active"><a href="#">Editar curso</a></li>
</ul>
<!-- PAGE TITLE -->
<div class="page-title">
    <h2><a href="{{url('dashboard/course')}}"><span class="fa fa-arrow-circle-o-left"></span></a> Ir a todos los cursos</h2>
</div>
<!-- END BREADCRUMB -->
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12 col-xs-12 panel-body form-group-separated">
                <form action="#" method="post" id="editCourse" name="editCourse"role="form" class="form-horizontal">
                    <input type="hidden" value="{{course.getImage()}}" name="image" id="img-principal" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input id="url-title" type="text" class="form-control" placeholder="Nombre del curso" name="name" value="{{course.getName()}}" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input id="note-permalink" type="text" class="form-control" placeholder="Enlace o Permalink" name="permalink" value="{{course.getPermalink()}}" required readonly/>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div id="image-principal-edit-1" class="dropzone dz-default dz-message">
                                <div class="dz-default dz-message">
                                    <h2>
                                        ...
                                        <input type="hidden" value="{{course.getImage()}}" name="image-1" id="image-1">
                                    </h2>
                                </div>
                            </div>
                            <br/>
                            ...
                            <div id="image-principal-edit-2" class="dropzone dz-default dz-message">
                                <div class="dz-default dz-message">
                                    <h2>
                                        ...
                                        <input type="hidden" value="{{course.getImage()}}" name="image-2" id="image-2">
                                    </h2>
                                </div>
                            </div>
                            <br/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <textarea class="form-control" name="description" id="description" cols="10" rows="5">{{course.getDescription()}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <textarea placeholder="Objetivos" class="form-control ckeditor" name="objective" id="objective" rows="5" cols="20">{{course.getObjective()}}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <div class="block">
                                <textarea class="form-control ckeditor"  name="directed" id="directed" rows="10" cols="80">{{course.getDirected()}}</textarea>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <div class="block">
                                <textarea class="form-control ckeditor" name="content" id="content" rows="10" cols="80">{{course.getContent()}}</textarea>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <select id="cid" name="category" class="form-control" required multiple="multiple">
                                <?php foreach ($category as $key => $sub):?>
                                    <option <?=$course->getCgid()==$key?"selected":"";?> value="{{key}}">{{sub}}</option>
                                <?php endforeach;?>
                            </select>
                        </div>
                    </div>

...
<ul class="breadcrumb">
    ...
    <li><a href="<?php echo $this->url->get('dashboard/course'); ?>">Cursos</a></li>
    <li class="active"><a href="#">Editar curso</a></li>
</ul>
<!-- PAGE TITLE -->
<div class="page-title">
    <h2><a href="<?php echo $this->url->get('dashboard/course'); ?>"><span class="fa fa-arrow-circle-o-left"></span></a> Ir a todos los cursos</h2>
</div>
<!-- END BREADCRUMB -->
<div class="page-content-wrap">
    <div class="row">
        <div class="col-md-12">
            <h4 class="text-title">Editar Curso</h4>
            <div class="col-md-12 col-xs-12 panel-body form-group-separated">
                <form action="#" method="post" id="editCourse" name="editCourse"role="form" class="form-horizontal">
                    <input type="hidden" value="<?php echo $course->getImage(); ?>" name="image" id="img-principal" >
                    <input type="hidden" value="<?php echo $course->getCid(); ?>" name="cid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input id="url-title" type="text" class="form-control" placeholder="Nombre del curso" name="name" value="<?php echo $course->getName(); ?>" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <input id="note-permalink" type="text" class="form-control" placeholder="Enlace o Permalink" name="permalink" value="<?php echo $course->getPermalink(); ?>" required readonly/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 col-xs-12 control-label">Imagen</label>
                        <div class="col-md-4 col-xs-12">
                            <div id="image-principal-edit-1" class="dropzone dz-default dz-message">
                                <div class="dz-default dz-message">
                                    <h2>
                                        ...
                                        <input type="hidden" value="<?php echo $course->getImage(); ?>" name="image-1" id="image-1">
                                    </h2>
                                </div>
                            </div>
                            <br/>
                        ...
                        <div class="col-md-4 col-xs-12">
                            <div id="image-principal-edit-2" class="dropzone dz-default dz-message">
                                <div class="dz-default dz-message">
                                    <h2>
                                        ...
                                        <input type="hidden" value="<?php echo $course->getImage(); ?>" name="image-2" id="image-2">
                                    </h2>
                                </div>
                            </div>
                            <br/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <textarea class="form-control" name="description" id="description" cols="10" rows="5"><?php echo $course->getDescription(); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <textarea placeholder="Objetivos" class="form-control ckeditor" name="objective" id="objective" rows="5" cols="20"><?php echo $course->getObjective(); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <div class="block">
                                <textarea class="form-control ckeditor"  name="directed" id="directed" rows="10" cols="80"><?php echo $course->getDirected(); ?></textarea>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-xs-12">
                            <div class="block">
                                <textarea class="form-control ckeditor" name="content" id="content" rows="10" cols="80"><?php echo $course->getContent(); ?></textarea>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" placeholder="Duración del curso" name="duration" value="<?php echo $course->getDuration(); ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <select id="cid" name="category" class="form-control" required multiple="multiple">
                                <?php foreach ($category as $key => $sub):?>
                                    <option <?=$course->getCgid()==$key?"selected":"";?> value="<?php echo $key; ?>"><?php echo $sub; ?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <select id="status" name="status" class="form-control selectU" required multiple>
                                <option <?=$course->getStatus()=="ACTIVE"?"selected":"";?> value="ACTIVE">Activo</option>
                                <option <?=$course->getStatus()=="INACTIVE"?"selected":"";?> value="INACTIVE">Inactivo</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <form method="post" action="" name="form-tag" id="form-tag">
                <div class="modal-body">
                    <div class="col-lg-8">
                        ...
                        <br>
                        <?php } else { ?>
                        <input type="hidden" name="cgid" value="<?php echo $autg['cgid']; ?>"/>
                        <?php } ?>
                    </div>
                </div>
                <div class="clearfix"></div>
